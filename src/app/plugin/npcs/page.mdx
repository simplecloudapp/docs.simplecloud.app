...
You don't want to use our own implementation of [juliarns NPC-Lib](https://github.com/juliarn/npc-lib)?
...
| Software                                                                              | Supported Versions      | This Plugin |
|---------------------------------------------------------------------------------------|-------------------------|-------------|
...
If you would like to add support for a missing npc plugin, feel free to submit a pull request on [GitHub](https://github.com/theSimpleCloud/npc-plugin/pulls).
