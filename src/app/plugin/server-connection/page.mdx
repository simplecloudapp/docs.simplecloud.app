...
An environment variable rule compares an environment variable to a given value with a specified [matcher operation](#matcher-operations) (just not in the context of server names, but environment variable values of course).
