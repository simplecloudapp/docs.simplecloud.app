...
export const sections = [
    { title: 'What is the proxy plugin?', anchor: 'description' },
    { title: 'What can the proxy plugin do?', anchor: 'features' },
    { title: 'How can I set the proxy plugin?', anchor: 'configuration' },
    { title: 'Is there a plugin API?', anchor: 'plugin-api' },
    { title: 'How can I install the plugin?', anchor: 'installation' },
    { title: 'What platforms does the plugin run on?', anchor: 'Supported-platforms' },
]
