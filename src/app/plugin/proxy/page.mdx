...
export const sections = [
    { title: 'What is the proxy plugin?', anchor: 'what-is-the-proxy-plugin' },
...
## What is the proxy plugin?

The Proxy Plugin is a versatile tool designed to enhance your server network's Message of the Day (MOTD) and TabList features. It offers a range of customization options to tailor these aspects to your specific needs.
