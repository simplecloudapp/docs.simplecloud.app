...
## Dynamic properties
Dynamic properties are group properties, which are needed by the [Server Host Droplet](/droplet/serverhost) or custom properties for your personal use. You can use
...
<Note>
    ...
    [here](/droplet/serverhost#group-properties)
</Note>
