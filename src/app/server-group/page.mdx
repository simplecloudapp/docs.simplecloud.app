...
## Dynamic properties
Dynamic properties are group properties, which are needed by the [serverhost droplet](/droplet/serverhost) or custom properties for your personal use. You can use
...
<Note>
    ...
    [here](/droplet/serverhost#needed-group-properties)
</Note>
