...
<Note>
    An actions ref name consists of the YAML file name it is located in and the name of the action. For example, an action in `utils.yml` called `init-placeholders` will have the ref `utils/init-placeholders`.
</Note>
