...
To assign a template to a group, set `template-id` to your wanted template id (e.g. if your wanted template is stored in `lobby.yml`, your template id is `lobby`) in the [properties](/serverhost-droplet#group-properties) of the lobby group.