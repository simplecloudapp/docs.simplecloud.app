...
<CodeGroup>
```yaml {{title: 'every_paper.yml'}}
# droplets/serverhost/templates/internal/every/every_paper.yml
extends: "every_spigot"
destinations:
- copy-from: "every_paper"
copy-to: ""
```

```yaml {{title: 'dynamic_paper.yml'}}
# droplets/serverhost/templates/internal/dynamic/dynamic_paper.yml
extends: "every_paper"
destinations:
  - copy-from: "cache/paper/%GROUP%/cache"
    copy-to: "cache"
