...
| `dest`    | `path` (default `""`)       | The path to put the compressed Archive in (leave blank to put it in the same directory as the folder you're compressing is in) |
...
| `dest`    | `path` (default `""`)       | The path to put the decompressed Files in  (leave blank to put it in the same directory as the file you're decompressing is in) |
