...
### Remote Management
The CLI can be installed and run from anywhere, allowing you to manage your cloud system from your local machine while the cloud runs on remote servers.
