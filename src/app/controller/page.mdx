...
The controller is very basic. It's just a small program, that keeps track of [server groups](/server-group) and their online [servers](/server) and manages them. It is the heart of SimpleCloud v3. {{ className: 'lead' }}
