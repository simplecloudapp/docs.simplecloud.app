...
No, the controller does not start droplets. That is the job of our [CLI](/cli) or yours. The controller is really just responsible for managing servers and server groups.