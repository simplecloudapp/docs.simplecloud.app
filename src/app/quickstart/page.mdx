...
- [Select wanted plugins](/cli/plugins)
- [Select wanted droplets](/cli/droplets)
- [Create your first group](/cli/group)
- [Learn about the structure](/structure)
- [Create a template](/serverhost/template)
- [Learn about the SDKs](/sdk)
