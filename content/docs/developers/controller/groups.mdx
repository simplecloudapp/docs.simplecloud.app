...
Before you can use the Groups API, you need to initialize the Controller API. Please refer to the [Initialization](/developers/getting-started/initialization) guide for more information.
