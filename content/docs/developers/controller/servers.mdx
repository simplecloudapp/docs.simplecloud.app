...
Before you can use the Servers API, you need to initialize the Controller API. Please refer to the [Initialization](/docs/developers/getting-started/initialization) guide for more information.
