...
Before you can use the Player API, you need to initialize the Player API. Please refer to the [Initialization](/docs/developers/getting-started/initialization) guide for more information.
