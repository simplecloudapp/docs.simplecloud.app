...
The placeholders plugin integrates with [PlaceholderAPI](https://github.com/PlaceholderAPI/PlaceholderAPI) to expose all important parameters from the [Controller API](/api/controller) as placeholders. This allows you to access server and group information dynamically in your server configurations.
...
- [Server Management](/manual/resources/servers)
- [Group Configuration](/manual/resources/groups)
- [API Documentation](/api/controller)
