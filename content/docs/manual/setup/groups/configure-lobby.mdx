...
In order to make the proxy redirect players to the correct server, you need to configure our [Proxy Connection Plugin](/manual/plugins/proxy-connection). This plugin is included by default with SimpleCloud.
