...
| Droplet                                                      | Description                        |
| ------------------------------------------------------------ | ---------------------------------- |
| [Server Host](/docs/manual/droplet/serverhost)               | Manages Minecraft server instances |
| [Server Host Docker](/docs/manual/droplet/serverhost-docker) | Docker-based server management     |
