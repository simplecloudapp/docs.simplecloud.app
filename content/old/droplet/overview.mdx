...
A droplet is SimpleCloud's interpretation of a microservice that extends the functionality of your SimpleCloud setup. Droplets can run custom code, interact with external services, or create custom APIs.
...
- V2 modules are being converted into simplified [plugins](/manual/plugin/overview)
...
| Droplet                                                 | Description                        |
| ------------------------------------------------------- | ---------------------------------- |
| [Server Host](/manual/droplet/serverhost)               | Manages Minecraft server instances |
| [Server Host Docker](/manual/droplet/serverhost-docker) | Docker-based server management     |
| [Player](/manual/droplet/player)                        | Player data and management         |
| [Resource Pack](/manual/droplet/resourcepack)           | Resource pack distribution         |

## What's Next?

Here are some helpful resources to continue exploring SimpleCloud:

- [Learn about Plugins](/manual/plugin/overview)
