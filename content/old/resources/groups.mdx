...
<Callout>
  ...
  [here](/docs/manual/cli#create-group)
</Callout>
...
In general it's not important to the [Controller](/docs/manual/controller) to know which group type
...
[Server Host Droplet](/docs/manual/droplet/serverhost) knows how to handle them.
...
- **Port Configuration**: Can be modified, if ports are already in use, the
  [Server Host Droplet](/docs/manual/droplet/serverhost) will pick up the next available port
- **Cloud Properties**: Can be customized based on your needs (see
  ...
  [Server Host Droplet](/docs/manual/droplet/serverhost)
...
[Server Host Droplet](/docs/manual/droplet/serverhost) to configure and manage servers. While you
...
<Callout>
  See the [Server Host Droplet documentation](/docs/manual/droplet/serverhost)
  for a complete list of required properties and their configurations.
</Callout>
...
[API documentation](/docs/manual/api#server-group).

## What's Next?

Here are a few links that might be helpful as you continue to explore SimpleCloud:

- [Configure Templates](/docs/manual/resources/templates)
- [Learn about Servers](/docs/manual/resources/servers)
- [Learn about the Server Host droplet](/docs/manual/droplet/serverhost)
